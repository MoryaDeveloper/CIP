...
namespace Cosmatic_Insurance.Areas.AdminPanel.Controllers
{
    public class RolesController : Controller
    {
        ...
        // GET: AdminPanel/Roles/Details/5
        ...
        // GET: AdminPanel/Roles/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminPanel/Roles/Create
        ...
        // POST: AdminPanel/Roles/Delete/5
